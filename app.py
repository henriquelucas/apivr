...
def consultar_produtos_alterados(id_loja: int):
    ...
    try:
        ...
        cur.execute("""
            ...
            JOIN produtoautomacao pa ON pa.id_produto = pc.id_produto
            WHERE pc.id_loja = %s
              AND pc.id_situacaocadastro = 1
              AND pc.dataultimopreco::DATE = CURRENT_DATE
        """, (id_loja,))
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao consultar produtos alterados: {str(e)}")
